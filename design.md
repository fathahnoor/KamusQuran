...
The core educational goal is to help users master approximately **80–90% of the most frequent vocabulary appearing in the Qur'an**, estimated at **10.000+ words** (expanded from an initial core of 300 high-frequency words), while also enabling deeper exploration of morphology, syntax, and contextual occurrence across the Qur'an.
...
- Coverage has expanded to 10.000+ words (500+ Quranic high-frequency, 750+ daily Arabic, 9.000+ from Nahwu/Sharf textbooks)
